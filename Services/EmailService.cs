...
public class EmailService : IEmailService
{
    ...
    {
        var buttonHtml = buttonText != null ? 
        ...
        * {{
        ...
        body::before {{
            ...
            background: 
                ...
                radial-gradient(circle at 80% 70%, rgba(100, 65, 165, 0.1) 0%, transparent 50%),
                radial-gradient(circle at 40% 80%, rgba(41, 217, 194, 0.05) 0%, transparent 50%);
            pointer-events: none;
            z-index: -1;
        }}
        ...
        .container {{
            ...
            box-shadow: 
                ...
                inset 0 0 60px rgba(41, 217, 194, 0.05);
        ...
        .header::before {{
            ...
            width: 200%;
            height: 200%;
            background: radial-gradient(circle, rgba(41, 217, 194, 0.1) 0%, transparent 70%);
        ...
        .plan-change {{
            background: linear-gradient(135deg, 
                ...
                rgba(41, 217, 194, 0.2) 100%);
            color: #40e0d0;
            padding: 25px;
            border-radius: 15px;
            text-align: center;
            margin: 25px 0;
            border: 1px solid rgba(41, 217, 194, 0.3);
            box-shadow: 
                0 0 30px rgba(41, 217, 194, 0.2),
                inset 0 0 30px rgba(41, 217, 194, 0.1);
        }}
        
        .plan-change strong {{
            color: #fff;
            font-size: 18px;
            text-shadow: 0 0 10px rgba(41, 217, 194, 0.5);
        }}
...
<body>
    ...
    public async Task SendEmailVerificationAsync(string toEmail, string userName, string verificationToken)
    {
        ...
        var content = @"<p>¡Estamos emocionados de tenerte en CrudCloud! Para comenzar a crear tus bases de datos en la nube, necesitamos que verifiques tu dirección de correo electrónico.</p>
            <div class='highlight'>
                <strong>Importante:</strong> Tu cuenta no estará completamente activa hasta que verifiques tu email.
            </div>
            <p>Haz clic en el botón de abajo para completar la verificación:</p>";
    ...
    public async Task SendWelcomeEmailAsync(string toEmail, string userName)
    {
        ...
        var content = @"<p>¡Felicidades! Tu cuenta ha sido verificada exitosamente y ahora estás listo para comenzar.</p>
            <div class='highlight'>
                <strong>¿Qué puedes hacer ahora?</strong><br>
                • Crear bases de datos MySQL, PostgreSQL, MongoDB<br>
                • Gestionar múltiples instancias<br>
                • Escalar según tus necesidades
            </div>
            <p>Inicia sesión en tu cuenta y descubre todas las funcionalidades que tenemos para ti.</p>";
    ...
    public async Task SendPlanUpgradeNotificationAsync(string toEmail, string userName, string oldPlan, string newPlan)
    {
        ...
        var content = $@"<p>Te informamos que tu suscripción ha sido actualizada exitosamente.</p>
            <div class='plan-change'>
                <strong>Cambio de Plan</strong><br>
                <span style='font-size: 18px;'>De <strong>{oldPlan}</strong> a <strong>{newPlan}</strong></span>
            </div>
            <p>Los nuevos límites y características de tu plan están ahora activos. ¡Disfruta de las mejoras!</p>
            <div class='highlight'>
                <strong>Tip:</strong> Revisa las nuevas capacidades de tu plan en el panel de control.
            </div>";
